...
export default function ServicesSection() {
    ...
    return (
        <section className="bg-white min-h-[80vh] flex items-center justify-center py-[100px] px-6 overflow-hidden relative">
            ...
            <div className="w-full max-w-[1200px] relative z-10">
                <div className="mb-[80px] text-center flex flex-col items-center">
                    ...
                    >
                        Our ecosystem is meticulously designed to align incentives and solve the systemic challenges of key stakeholders.
                    </p>
                </div>
                    ...
                    {data.map((item, i) => (
                        ...
                        >
                            ...
                            <ul className="list-none p-0 m-0 flex flex-col gap-3.5 relative z-10">
                                {item.list.map((point) => (
                                    <li key={point} className="text-[15px]  text-[#2A2A2A]/60 flex items-center gap-3 tracking-wide transition-all duration-300 group-hover:text-[#2A2A2A] group-hover:translate-x-1">
                            ...
                            <div className="absolute bottom-10 right-10 w-9 h-9 border border-[#21428E]/25 rounded-full flex items-center justify-center opacity-0 translate-y-2 transition-all duration-400 group-hover:opacity-100 group-hover:translate-y-0 group-hover:border-[#21428E]/60 group-hover:bg-[#21428E]/10 z-10">
                                <svg viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3">
                                    <path d="M2 10L10 2M10 2H4M10 2V8" stroke="#21428E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                            </div>
                        </div>
                    ))}
